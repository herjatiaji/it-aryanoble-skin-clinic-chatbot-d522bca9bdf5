...
export function BatchReviewSkeleton() {
	return (
		<div className="flex flex-col h-full bg-white relative animate-pulse">
			{/* Header Skeleton */}
			<div className="flex items-center gap-3 px-4 py-3 border-b border-zinc-200 justify-between bg-white shrink-0">
				<div className="flex items-center gap-3 min-w-0">
					<Skeleton className="size-9 rounded-lg shrink-0" />
					<Skeleton className="h-5 w-44 rounded shrink-0" />
					<div className="h-4 w-px bg-zinc-200 shrink-0 hidden sm:block" />
					<Skeleton className="h-9 w-64 sm:w-80 rounded-lg shrink-0" />
				</div>
			...
			<div className="flex flex-col flex-1 overflow-hidden">
				{/* Top Tabs & Executive Summary */}
				<div className="px-4 sm:px-6 pt-4 space-y-3 shrink-0 max-w-5xl mx-auto w-full">
					{/* Tabs Sub-header & Tab List */}
					<div className="flex flex-col gap-2 w-full">
						<div className="flex items-center justify-between gap-2">
							<Skeleton className="h-4 w-44 rounded" />
							<Skeleton className="h-6 w-36 rounded-md" />
						</div>
						<div className="flex items-center gap-2 pb-1.5 overflow-hidden">
